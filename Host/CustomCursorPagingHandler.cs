...
class CustomCursorPagingHandler<TEntity>(PagingOptions options)
    : CursorPagingHandler(options)
{
        ...
        CursorPagingArguments arguments)
    {
        ...
        if (arguments.After is not null)
        {
            ...
            var (whereExpr, _) = CustomExpressionHelpers.BuildWhereExpression<TEntity>(keys, cursor, true);
        ...
        if (arguments.Before is not null)
        {
            ...
            var (whereExpr, _) = CustomExpressionHelpers.BuildWhereExpression<TEntity>(keys, cursor, false);
            query = query.Where(whereExpr);
        }
